...
class StatusBar extends View {
  ...
  initialize(statusBarProvider) {
    ...
    this.statusContainer.on('dragstart', '.terminus-status-icon', this.onDragStart.bind(this));
    this.statusContainer.on('dragend', '.terminus-status-icon', this.onDragEnd.bind(this));
    this.statusContainer.on('dragleave', this.onDragLeave.bind(this));
    this.statusContainer.on('dragover', this.onDragOver.bind(this));
    this.statusContainer.on('drop', this.onDrop.bind(this));
  ...
  registerPaneSubscription() {
    this.subscriptions.add(this.paneSubscription = atom.workspace.observePanes(pane => {
      ...
      pane.onDidDestroy(() => tabBar.off('drop', this.onDropTabBar.bind(this)));
    }));
  }
